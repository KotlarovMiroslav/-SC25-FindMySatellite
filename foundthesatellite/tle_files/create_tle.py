...
def read_points(waypoints):
    ...
    ----------
    waypoint : array-like
        waypoint[0,:] -> azimuth, the turn of the stepper  
        waypoint[1,:] -> elevation, the inclination of the servo  
        waypoint[2,:] -> range, distance from the station (lidar reading)  
        waypoint[3,:] -> time after starting the readings  
    ...
    -------
    tuple
        phi and theta in rad, distance in km and time in s
    """
    azimuth = waypoints[0, :]
